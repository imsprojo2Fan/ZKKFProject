    ...
    var templates = {
        "font-styles": "<li class='dropdown'>" +
                           "<a class='btn dropdown-toggle' data-toggle='dropdown' href='#'>" +
                               "<i class='icon-fonts'></i>&nbsp;<span class='current-fonts'>Normal text</span>&nbsp;<b class='caret'></b>" +
                           "</a>" +
        ...
        "lists":       "<li>" +
                           "<div class='btn-group'>" +
                               ...
                               "<a class='btn' data-wysihtml5-command='Outdent' title='Outdent'><i class='fa fa-outdent'></i></a>" +
    ...
    Wysihtml5.prototype = {
        ...
        createToolbar: function(el, options) {
            ...
            toolbar.find("a[data-wysihtml5-command='formatBlock']").click(function(e) {
                var el = $(e.srcElement);
                self.toolbar.find('.current-fonts').text(el.html());
            });
